...
class Rectangle
	...
	def initialize top_right_corner_x_coordinate, top_right_corner_y_coordinate, vertical_side_length, horizontal_side_length
		@x = top_right_corner_x_coordinate
		@y = top_right_corner_y_coordinate
		@vl = vertical_side_length
		@hl = horizontal_side_length
		@z = 0
		@m = :default
